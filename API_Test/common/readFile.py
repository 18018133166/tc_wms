...
class ReadFile(object):
    ...
    def __init__(self):
        ...
        self.sys_config_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'config/sys_config.yaml')
    ...
    def read_yaml(self, path_type):
        ...
        """
        try:
            if path_type == 'sys_config_path':
                file_path = self.sys_config_path
